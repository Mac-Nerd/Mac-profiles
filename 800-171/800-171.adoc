...
:show_cis!:
ifdef::backend-pdf[]
= macOS 12: Security Configuration - NIST 800-171 Rev 2
...
:document-title: macOS 12
:document-subtitle:  Security Configuration - NIST 800-171 Rev 2
...
This guide describes the actions to take when securing a macOS 12 system against the 800-171 Rev 2 baseline.
