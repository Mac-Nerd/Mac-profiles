...
:show_cis!:
ifdef::backend-pdf[]
= macOS 12 Security Configuration: NIST SP 800-53 Rev 5 Moderate Impact Security Baseline
...
:document-subtitle:  NIST SP 800-53 Rev 5 Moderate Impact Security Baseline
