...
:show_cis!:
ifdef::backend-pdf[]
= macOS 12: Security Configuration - CNSSI-1253
...
:document-subtitle:  Security Configuration - CNSSI-1253
...
This guide describes the actions to take when securing a macOS 12 system against the CNSSI-1253 baseline.
